    ...
    return (
        <div className={footerstyle.footer}>
            <div className={footerstyle.socialmedia}>
                <a href="https://www.facebook.com/hopeorgeonofstars-309631359937695/?__tn__=%2Cd%2CP-R&eid=ARDvvJO-Pv5b_GV6VKvU2mQrIRjtI5OyACb_aM537mwafkSKiaxancgNBDn6GvmiZe665-UZjsOKq1qY" target="_blank" rel="noreferrer">
                    <FaFacebookF className={footerstyle.icon} />
                </a>
                <a href="https://www.instagram.com/hopeorgeonofstars/" target="_blank" rel="noreferrer">
                    <FaInstagram className={footerstyle.icon} />
                </a>
                <a href="https://www.youtube.com/channel/UChDw2wQiCqw0s0aSLph3sPA/videos" target="_blank" rel="noreferrer">
