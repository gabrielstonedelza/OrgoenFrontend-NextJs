import privacyStyle from '../styles/privacy/Privacy.module.css'

const privacy = () => {
    return (
        <div className={privacyStyle.privacycontainer}>
            <h2>Orgeonofstars' Privacy Statement</h2>
            <p>Thanks for entrusting GitHub Inc. (“GitHub”, “we”) with your source code, your projects, and your personal information. Holding on to your private information is a serious responsibility, and we want you to know how we're handling it.</p>
            ...
            <ul>
                ...
                <li>Application means the software program provided by the Company downloaded by You on any electronic device, named Rvci</li>
                <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Rvci.</li>
                <li>Country refers to: Ghana</li>
            ...
            <ul>
                <li>By email: gabrielstonedelza@gmail.com</li>
                <li>By phone number: +233593380008</li>
            </ul>
        </div>
    )
}
